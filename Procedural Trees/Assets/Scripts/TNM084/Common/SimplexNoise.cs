// This class copied and modified from https://gist.github.com/boj/1759876
// It is a C# version of the Java Simplex Noise by Stefan Gustavsson
// from http://webstaff.itn.liu.se/~stegu/simplexnoise/simplexnoise.pdf.
// I added the suggested code change to the 3D Simplex Noise described
// in the PDF Stefan Gustavsson, see line 193.
  ...
  138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180};
    ...
    new int[] {2,1,0,3}, new int[] {0,0,0,0}, new int[] {0,0,0,0}, new int[] {0,0,0,0}, new int[] {3,1,0,2}, new int[] {0,0,0,0}, new int[] {3,2,0,1}, new int[] {3,2,1,0}};
        ...
        public static double noise(double xin, double yin, double zin)
        {
            ...
            // Changed the value from 0.6 to 0.5, as was described in
